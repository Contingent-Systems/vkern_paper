...
\end{itemize}
In fact $\readlval\maddr{\storememstar\crval}\locsf$ is unfoled into multiple physical memory lookups for the final page address retrieval -- i.e. address translation traversal as shown in Figure \fref{fig:addresstranslationtraversal}  \mytodo{1.address more about the challenging aspects of this traversal and the last level update 2. Put the figure Colin sent }
\input{fig-semantics}
