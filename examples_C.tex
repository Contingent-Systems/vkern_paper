...
This is the role of \lstinline|pte_get_next_table| (Figures \ref{fig:calltopteinitializeC} and \ref{fig:p2vC}):
...
Figure \ref{fig:p2vC} (discussed in Section \ref{sec:p2vC}) deals with the cases where no allocation is necessary \emph{or} the allocation has already
...
pte_t *pte_get_next_table(pte_t *entry) {
  ...
  /*Physical to virtual address mapping code segment starts here (*\ref{fig:p2vC}*)*/
...
in the last lines of \lstinline|pte_get_next_table| shown in Figure \ref{fig:p2v} (the continuation of Figure \ref{fig:calltopteinitializeC}).
