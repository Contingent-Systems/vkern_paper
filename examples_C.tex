...
\todo[inline,color=cyan]{
  reading carefully, it says that if entry\_present of pte\_initialize of something holds (which it always will)
  then the 512 entries are there. So this is basically ``True implies'', but in a shape that's compatible
  with the other branch/path's invariants
}
\vspace{-1em}
