...
\end{lstlisting}
\todo[inline]{same entry confusion of virt program and phys logical; fix and explain names}
\else
...
Also, these should be 4 different fractions, not all qfrac
}
...
\todo[inline,color=cyan]{
  Ismail, shouldn't the precondition include the 512 tokens for the L4 table, and shouldn't the l4 entry be excluded from $\Xi$?
  Assuming yes, I need to add a note that they're carried around in the general kernel invariant.
}
