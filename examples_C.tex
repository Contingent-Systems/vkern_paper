...
%\label{fig:p2v}
%\end{figure}
Lines \ref{childrenC}-\ref{line:p2vC} in Figure \ref{fig:calltopteinitializeC} show the verification of the end of \lstinline|pte_get_next_table| specialized to the case where 
