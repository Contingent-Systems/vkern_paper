...
\replace{
ARMv8 (a.k.a.\ texttt{aarch64}), RISC-V, and PowerPC use similar hierarchical page tables for address translation.
...
logics \del{(including ours)} often encapsulate raw \rocq assertions: $\ulcorner P \urcorner$ is an embedding
...
This explicit naming of alternate worlds increases the power of \add{propositional} modal logics~\cite{blackburn1995hybrid}, and is actually
...
the primary goal of a modal logic is not expressive power but intuitive readable specifications.
