...
\label{sec:seplogic}
\todo[inline]{Colin says: I added this b/c prior systems reviewers wanted more verification background...
...
that because \iris is an embedded framework in Rocq, proofs in \iris-derived
...
general pure logical assertions). Newly-defined \iris assertions are in fact
