...
\begin{figure}
    ...
    \caption{x86-64 page table lookups.}
        \todo[inline]{Colin says: I recommend the cr3 caption say "Physical Base Address" rather than just
                base address.
            If we're saying in the text that we just to L4, L3, L2, L1, then the figure should do the same.
        }
...
the classic example being that if $P$ is true, then $P$ is \emph{necessarily} true ($\square P$).
...
with assertions of the form $@_\ell(P)$ indicating that $P$ is true in the specific alternate circumstance (Kripke world)
...
$@_\ell(P)$, has a natural analogue: knowing $P$ and that the current address space is $r$ (i.e., that $r$ is the 
