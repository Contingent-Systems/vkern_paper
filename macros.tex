...
\newcommand{\nfpointsto}[5]{#1 / #2 \mapsto_{#5}\{#4\}\;#3}
\newcommand{\mask}[3]{#1|^{#2}(#3)}
\newcommand{\ft}{52}
\newcommand{\tw}{12}
...
\newcommand{\entryf}{\textsf{PML4E}}
\newcommand{\entrytr}{\textsf{PDPE}}
\newcommand{\entrytw}{\textsf{PDE}}
\newcommand{\entryo}{\textsf{PTE}}
