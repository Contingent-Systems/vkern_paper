...
\begin{itemize}
\item we develop these ideas in an Iris-based\mytodo{cite JFP} separation logic, a logic for address-virtualization (\textsf{vProp} in Figure \ref{fig:architecture})
