...
\begin{remark}[Hiding What is Stackable in a Modal Context?] 
\end{remark}
\begin{remark}[Custom-Tailored Modal Abstractions for a Each Stackable Data-Structure]
\end{remark}
\begin{remark}[Not only Being Stackable But How?]
\end{remark}
