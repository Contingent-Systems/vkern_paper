...
$\specline{\sumapaces\rtv\delta \ast \mathsf{nextpaddr} \in \Xi\setminus \{ \mathsf{entry} \} \} }_{\rtv}$
...
$\specline{\textsf{P} \ast \mathcal{I}\texttt{ASpace}_{\textsf{id}}(\theta,\Xi,m)   \ast \texttt{rbp-16} \mapsto_{\textsf{v}} \textsf{\_} \ast \texttt{rdi}  \mapsto_{\textsf{r}} \textsf{table\_addr}  }_{\rtv}$
$\specline{\texttt{rax} \mapsto_{\textsf{v}} \textsf{nextpaddr} \ast \textsf{table\_addr} \mapsto_{\mathsf{v}} \mathsf{\_} \ast \textsf{nextpaddr} \mapsto_{\textsf{p}} \textsf{w0\_64}\ast\sumapaces\rtv\delta }_{\rtv}$
mov    rax,-0x10[rbp] 
...
$\specline{\texttt{rax} \mapsto_{\textsf{v}} \textsf{nextpaddr} \ast \ulcorner \Xi \;!!\; \mathsf{nextpaddr} = Z \urcorner \ast \textsf{table\_addr} \mapsto_{\mathsf{v}} \mathsf{\_} \ast \textsf{nextpaddr} \mapsto_{\textsf{p}} \textsf{w0\_64} \ast \sumapaces\rtv\delta }_{\rtv}$  
;;*table = local;
mov    -0x10[rbp],rax
mov    -0x8[rbp],rdi
mov    rax,[rdi]
$\specline{\textsf{P} \ast \mathcal{I}\texttt{ASpace}_{\textsf{id}}(\theta,\Xi,m)   \ast \texttt{rbp-16} \mapsto_{\textsf{v}} \textsf{nextpaddr} \ast \texttt{rdi}  \mapsto_{\textsf{r}} \textsf{table\_addr}  }_{\rtv}$
$\specline{\texttt{rax} \mapsto_{\textsf{v}} \textsf{nextpaddr}  \ast \textsf{table\_addr} \mapsto_{\mathsf{v}} \mathsf{\mathsf{nextpaddr}} \ast \textsf{nextpaddr} \mapsto_{\textsf{p}} \textsf{w0\_64} \ast \sumapaces\rtv\delta }_{\rtv}$  
;;return;
;;..
;;clean up the stack
\end{lstlisting}
