...
The critical challenges of verifying this code relate to both proving memory safety of the traversal, and peeling out enough resources from the per-address-space
