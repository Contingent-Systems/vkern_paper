...
$\specline{ \textsf{entry-KERNBASE} \mapsto_{\textsf{vpte,qfrac}} \textsf{entry entry\_val} \ast \ulcorner \textsf{qfrac}=1 \leftrightarrow \textsf{not\_present entry} \urcorner}$
mov    [r8],rdi
