...
$\specline{\textsf{entry+KERNBASE} \mapsto_{\textsf{pte,1}} \textsf{entry entryv} \ast \ghostmaptoken{\textsf{id}}{(\mathsf{entry})}{\textsf{level}} }$
...
$\specline{\textsf{entry+KERNBASE} \mapsto_{\textsf{pte,q}} \textsf{entry entryv} \ast \ghostmaptoken{\textsf{id}}{(\mathsf{entry})}{\textsf{level}} }$
