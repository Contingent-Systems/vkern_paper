...
fpaddr)) in Line 30. Reaching right at this point in the specification, we must note that we did find a trivial inconsistency in the postcondition related to conflating fpaddr as an address with the page table entry that reference fpaddr, and while the fix is straightforward we ran out of time.
