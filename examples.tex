...
At this point in the proof, i.e. after the traversal to obtain the sound physical path resources ($\textsf{R}_{\textsf{walk\_acc}}$ Line 27 in Figure \ref{walkpgdir}), which coontains
