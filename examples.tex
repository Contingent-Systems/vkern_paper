...
$\specline{\textsf{P} \ast \mathcal{I}\texttt{ASpace}_{\textsf{id}}(\theta,\Xi,m)   \ast \texttt{rbp-16} \mapsto_{\textsf{v}} \textsf{next} \ast \texttt{rdi}  \mapsto_{\textsf{r}} \textsf{table\_addr}  }_{\rtv}$
$\specline{\texttt{rax} \mapsto_{\textsf{v}} \textsf{nextpaddr} \ast \ulcorner \Xi \;!!\; \mathsf{nextpaddr} = \textsf{None} \urcorner \ast \textsf{table\_addr} \mapsto_{\mathsf{v}} \mathsf{\_} \ast \sumapaces\rtv\delta }_{\rtv}$
$\sqsubseteq$
