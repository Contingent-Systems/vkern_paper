...
call ensure_L1_page ;; Returns the virtual address of the L1 entry in rax
...
The code uses a (currently axiomatized) helper function \lstinline|ensure_L1| (discussed again in Section \ref{sec:traversing}).
\lstinline|ensure_L1|'s postcondition contains physical pointsto assertions for a partial page table walk reaching the
