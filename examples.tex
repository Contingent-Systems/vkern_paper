...
;; pte_t *next;
$\specline{\textsf{P} \ast \mathcal{I}\texttt{ASpace}_{\textsf{id}}(\theta,\Xi\setminus\{\textsf{entry}\},m) \ast \textsf{entry}\mapsto_{\textsf{pte,q}}\textsf{entryv} \ast \texttt{rbp-8} \mapsto_{\textsf{v}} \textsf{entry} \ast  \texttt{rbp-16} \mapsto_{\textsf{v}} \textsf{next} \ast \texttt{r8}  \mapsto_{\textsf{r}} \textsf{\_} \ast \texttt{rdi}  \mapsto_{\textsf{r}} \textsf{\_}  }_{\rtv}$
...
$\specline{  \urcorner \ast \ghostmaptoken{\delta{}s}{\rtv}{\delta}  }_{\rtv}$
mov     rdi, r8
...
$\specline{\ghostmaptoken{\delta{}s}{\rtv}{\delta} \ast \mathsf{nextpaddr} \in \Xi\setminus \{ \mathsf{entry} \} \} }_{\rtv}$
