...
$\specline{ \textsf{entry} \mapsto_{\textsf{id}} \textsf{_} \ast \textsf{entry\_val}_{\textsf{pfn}} \mapsto_{\textsf{id}} \textsf{\_} \ast \forall_{i\in \textssf{0 ... 511} } \ldotp  \textsf{entry\_val }_{\textsf{pfn}} + \texstf{i * 8} \mapsto_{\textsf{id}} \textsf{\_}   \ast \ghostmaptoken{\delta{}s}{\rtv}{\delta}  }_{\rtv}$
