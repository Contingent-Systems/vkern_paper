...
$\specline{\ulcorner \texttt{aligned fpaddr} \urcorner \ast \texttt{rax}\mapsto_{r} \texttt{fpaddr} \ast \texttt{aligned va} \ast\sumwalkabs\vaddr\qfrac\textsf{fpaddr}}_{\rtv}$
\end{lstlisting}
...
by Rule \TirNameStyle{WriteToVirtMemFromReg} which allows proving virtual address updates without exposing its internal physical page-table memory accesses. 
