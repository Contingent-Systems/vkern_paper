...
invariant per Figure \ref{fig:peraspaceinvariant_with_p2v_extension}.\todo{should we also discuss the following before while introducing the invariant?} The extended invariant owns, for each memory location dedicated to page tables, some fraction of
