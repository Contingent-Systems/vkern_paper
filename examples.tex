...
\end{array}
 ...
 Accessing the presence bit and checking the value allow (Lines 7-13 in Figure \ref{fig:calltopteinitialize}) us to exploit the fact in the side condition (*) such that we can own twe introduced for the  
