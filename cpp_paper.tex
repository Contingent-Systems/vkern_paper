...
\title{Modalities for Virtualizing Memory Addresses}
\subtitle{Understanding the Locality with Modals}
%%
...
\todo[inline]{Colin think through instruction pointer updates vs logic,
think about framing plus cr3 update and modality shifts
}
