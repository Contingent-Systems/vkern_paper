...
\lstset{
  ...
  morekeywords={mov,add,call,and,or,xor,ret,push,pop},
  emph={rsp,rdx,rax,rbx,rbp,rsi,rdi,rcx,r8,r9,r10,r11,r12,r13,r14,r15,rflags,jmp,je,jlt,jge,jle,shiftr,shiftl},
...
Fully grounded trust for this would require a formal model of how hardware populates ACPI tables~\todo{cite} and formal verification of ACPI
parsing code on general-purpose desktop and server machines, or a formalized and verified
parsing of flattened device trees~\todo{cite device tree spec} (plus trust that a system was booted with a correct FDT) for (semi-)embedded systems like single-board
