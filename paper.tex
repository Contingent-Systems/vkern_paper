...
including \del{giving} the first assembly-level proof of correctness for a change
of address space expressing which assertions hold in which address space, 
\del{and} the first physical-to-virtual translation proof,
