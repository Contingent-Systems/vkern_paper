...
formalization of a subset of supervisor-mode x86-64 semantics,
specification and soundness proofs for the rules discussed in Section \ref{sec:logic}
as well as additional rules covering arithmetic and bitwise operations,
control transfers,\todo{Ismail, what are the caveats?}
and fixed-offset variants of the memory access rules from Figure \ref{fig:wpdamd}.
The main caveat is that our formalization does not explicitly model instruction
...
encoding a valid instruction sequence, used for branches, call, and return instruction
specifications).
