...
\inferrule[WriteToRegFromReg]{
  \{P \ast r_d \mapsto_{r} \texttt{rvs} \ast r_s \mapsto_{r}\{q\} \texttt{ rvs} \}\;\overline{ is}
}{
  \{P \ast r_d \mapsto_{r} \texttt{rvd} \ast r_s \mapsto_{r}\{q\} \texttt{ rvs} \}
  \texttt{ mov}~\texttt{r}_d,~\texttt{r}_s;\;\overline{is}
  %\lstinline|mov %cr3, r| 
}
\\
\inferrule[WriteToMemFromReg]{
  \{P \ast r_s \mapsto_{r}\{q\}  \texttt{rvs} \ast \lstinline|cr3| \mapsto_{r} \texttt{cr3val}  \ast r_a \mapsto_{r} \{q\} \texttt{ vaddr} \ast \texttt{vaddr} \mapsto_{t,\texttt{cr3val}} \texttt{v} \}\;\overline{ is}  
}{
  \{P \ast r_s \mapsto_{r}\{q\}  \texttt{rvs} \ast \lstinline|cr3| \mapsto_{r} \texttt{cr3val}  \ast r_a \mapsto_{r}\{q\} \texttt{ vaddr} \ast \texttt{vaddr} \mapsto_{t,\texttt{cr3val}} \texttt{rvs} \}
  \texttt{ mov}~\texttt{r}_a,~\texttt{r}_s;\;\overline{is}
}
\\
\inferrule[WriteToRegFromMem]{
  \{P \ast r_d \mapsto_{r}  \texttt{v} \ast \lstinline|cr3| \mapsto_{r} \texttt{cr3val}  \ast r_a \mapsto_{r} \{q\} \texttt{ vaddr} \ast \texttt{vaddr} \mapsto_{t,\texttt{cr3val}} \texttt{v} \}\;\overline{is}
}{
  \{P \ast r_d \mapsto_{r}  \texttt{rvd} \ast \lstinline|cr3| \mapsto_{r} \texttt{cr3val}  \ast r_a \mapsto_{r} \{q\} \texttt{ vaddr} \ast \texttt{vaddr} \mapsto_{t,\texttt{cr3val}} \texttt{v} \}
  \texttt{mov}~\texttt{r}_d,~\texttt{r}_a;\;\overline{is}
}
\\
\inferrule[WriteToRegCtlFromReg]{
  \{P \ast r_s \mapsto_{r}\{q\}  \texttt{ rvs} \ast \lstinline|cr3| \mapsto_{r} \texttt{rvs}  \}\overline{is}
}{
  \{P \ast r_s \mapsto_{r}\{q\}  \texttt{ rvs} \ast \lstinline|cr3| \mapsto_{r} \texttt{cr3val}  \}
  \texttt{mov}~\texttt{cr3},~r_s;\;\overline{is}
  %\lstinline|mov %cr3, r| 
}
\end{mathpar}
