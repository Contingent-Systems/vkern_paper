...
\paragraph{Physical-Memory points-to} Our physical memory points-to relation for a page table entry (e.g. \textsf{PDE} in Figure \ref{fig:physicalpointsto}) abstracts masking -- $|^{52}$ for frame for and $|^{12}$ for offset -- through logical nested maps.  
\begin{figure}[!ht]
\[
\begin{array}{cl}
