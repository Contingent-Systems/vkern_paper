...
\inferrule[WriteToMemFromReg]{
  \{P \ast r_s \mapsto_{r}\{q\}  \textsf{rvs} \ast \textsf{cr3} \mapsto_{r} \textsf{cr3val}  \ast r_a \mapsto_{r} \{q\} \textsf{ vaddr} \ast \textsf{vaddr} \mapsto_{\textsf{t},\textsf{cr3val}} \textsf{v} \}\;\overline{ is}  
}{
  \{P \ast r_s \mapsto_{r}\{q\}  \textsf{rvs} \ast \textsf{cr3} \mapsto_{r} \textsf{cr3val}  \ast r_a \mapsto_{r}\{q\} \textsf{ vaddr} \ast \textsf{vaddr} \mapsto_{\textsf{t},\textsf{cr3val}} \textsf{rvs} \}
  \textsf{ mov}~\textsf{r}_a,~\textsf{r}_s;\;\overline{is}
}
\\
\inferrule[WriteToRegFromMem]{
  \{P \ast r_d \mapsto_{r}  \textsf{v} \ast \textsf{cr3} \mapsto_{r} \textsf{cr3val}  \ast r_a \mapsto_{r} \{q\} \textsf{ vaddr} \ast \textsf{vaddr} \mapsto_{\textsf{t},\textsf{cr3val}} \textsf{v} \}\;\overline{is}
}{
  \{P \ast r_d \mapsto_{r}  \textsf{rvd} \ast \textsf{cr3} \mapsto_{r} \textsf{cr3val}  \ast r_a \mapsto_{r} \{q\} \textsf{ vaddr} \ast \textsf{vaddr} \mapsto_{\textsf{t},\textsf{cr3val}} \textsf{v} \}
