...
\todo[inline]{Colin says: the cr3 update rule should have IASpace (x2) and modalities...?}
...
are challenging to discharge due to some representation choices in our model.\footnote{See \texttt{srx/x64/machine/current_axioms.v}}
