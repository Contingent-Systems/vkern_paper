...
\begin{lstlisting}[language=Coq]
 Definition $\vaddr\mapsto_{\textsf{t}}\{\textsf{q}\}\vpage$ :vProp $\Sigma$ := 
  $\exists_{\entryf \;, \entrytr \;, \entrytw \;,\entryo} \ldotp$  $\ulcorner$ aligned $\vaddr \urcorner \ast$ L4_L1_PointsTo($\rtv,\entryf,\entrytr,\entrytw,\entryo$) $\ast \entryo \mapsto_{p} \vpage$.
