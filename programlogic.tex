...
\begin{figure*}
 ...
 Definition $\vaddr\mapsto_{\textsf{t}}\{\textsf{q}\}\; \vpage$ : vProp $\Sigma$ := 
  $\exists_{\textsf{l4e l3e l2e l1}} \ldotp$  $\ulcorner$ aligned $\vaddr \urcorner \ast$ L4_L1_PointsTo(maddr l4e l3e l2e l1e paddr) $\ast$ \textsf{paddr} $\mapsto_{p}\{\mathsf{q}\} \vpage$.
