...
\[
\begin{array}{l}
    \vaddr\mapsto_{\textsf{v}}\{\textsf{q}\}\vpage : \mathsf{vProp}~\Sigma \stackrel{\triangle}{=} 
...
\[
\begin{array}{l}
  \mathcal{I}\textsf{ASpace}(\ptablestore,m)\stackrel{\triangle}{:=} \exists\;\gammaPred \ldotp \; \lambda\textsf{ rtv} \ldotp \; \ulcorner m \; !!\; \textsf{rtv} = \textsf{Some } \gammPred \urcorner \ast
    \ownGhost\gammaPred{\authfull{\ptableabswalk\ptablestore}} \ast \\
  \bigast{(\vaddr, \textsf{l1e})\in \ptablestore}{\exists\;(\textsf{l4e l3e l2e})\ldotp \textsf{L}_{4}\_\textsf{L}_{1}\_\textsf{PointsTo}(\textsf{ maddr, l4e, l3e, l2e, l1e})}
\end{array}
\]
