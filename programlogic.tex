...
% ending with the L1 entry, 
% whose physical page base is added to the page offset of \textsf{va} to obtain the physical address
...
\footnotesize
  ...
  % translation.
  % Consistency follows from replacing the explicit page table walk of Figure \ref{fig:strongvirtualpointsto}'s
  % definition with ownership of the ghost map token for the relevant ghost map
  % entry, as in Figure \ref{fig:virtualpointstosharing}.
  % This allows the overall translation to be updated separately from the virtual points-to.
  \looseness=-1
...
As common for assembly-level verification, we define our logic using Hoare doubles:%\footnote{This
